<x-app-layout>
	...
	<x-card>
		...
		<x-slot name="option">
			<a href="{{ route('pm.tim.create') }}" class="btn btn-success">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						...
						<a href="{{ route('pm.tim.show', $tim->id_tim) }}" class="btn btn-primary mr-1"><i class="fas fa-eye"></i></a> 
						<a href="{{ route('pm.tim.edit', $tim->id_tim) }}" class="btn btn-primary mr-1"><i class="fas fa-edit"></i></a> 
						
						<form action="{{ route('pm.tim.delete', $tim->id_tim) }}" style="display: inline-block;" method="POST">
							@csrf
